...
% Need to explain why this is low-tech and why we need a high-level tool for that
...
\frametitle{Code generation \'a la Scala}
  ...
  \item Macros are becoming the tool of choice in a lot of situations
    ...
    \item A lot of popular libraries are using macros
    \end{itemize}
  \end{itemize}
\end{frame}

% Needs a good example here that shows that macros are really useful
% I'd use the specialized[T] example from what are macros good for
% But I'm a bit sick of it. Will try to think of something else
