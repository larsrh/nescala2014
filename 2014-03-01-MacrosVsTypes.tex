...
\begin{frame}{Credits}
  \begin{itemize}
    ...
    \item \text{\color{blue}\href{https://upload.wikimedia.org/wikipedia/commons/7/79/Operation_Upshot-Knothole_-_Badger_001.jpg}{Wikimedia Common}} for the nuclear explosion picture
